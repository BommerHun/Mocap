...
#include <stddef.h>
#include "vehicle_state_msgs/msg/detail/vehicle_state_stamped__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  vehicle_state_msgs__msg__VehicleStateStamped__init(message_memory);
}

void VehicleStateStamped__rosidl_typesupport_introspection_c__VehicleStateStamped_fini_function(void * message_memory)
{
  vehicle_state_msgs__msg__VehicleStateStamped__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember VehicleStateStamped__rosidl_typesupport_introspection_c__VehicleStateStamped_message_member_array[10] = {
  {
    "header",  // name
    ...
    offsetof(vehicle_state_msgs__msg__VehicleStateStamped, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_state_msgs__msg__VehicleStateStamped, position_x),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_state_msgs__msg__VehicleStateStamped, position_y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_state_msgs__msg__VehicleStateStamped, velocity_x),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_state_msgs__msg__VehicleStateStamped, velocity_y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_state_msgs__msg__VehicleStateStamped, heading_angle),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_state_msgs__msg__VehicleStateStamped, omega),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_state_msgs__msg__VehicleStateStamped, duty_cycle),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_state_msgs__msg__VehicleStateStamped, delta),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_state_msgs__msg__VehicleStateStamped, erpm),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers VehicleStateStamped__rosidl_typesupport_introspection_c__VehicleStateStamped_message_members = {
  ...
  10,  // number of fields
  sizeof(vehicle_state_msgs__msg__VehicleStateStamped),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_state_msgs, msg, VehicleStateStamped)() {
