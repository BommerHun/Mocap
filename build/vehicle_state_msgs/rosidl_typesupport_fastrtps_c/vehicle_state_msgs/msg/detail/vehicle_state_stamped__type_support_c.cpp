...
#include "vehicle_state_msgs/msg/detail/vehicle_state_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleStateStamped__ros_msg_type = vehicle_state_msgs__msg__VehicleStateStamped;
...
size_t get_serialized_size_vehicle_state_msgs__msg__VehicleStateStamped(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VehicleStateStamped__ros_msg_type * ros_message = static_cast<const _VehicleStateStamped__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _VehicleStateStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vehicle_state_msgs__msg__VehicleStateStamped(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vehicle_state_msgs
size_t max_serialized_size_vehicle_state_msgs__msg__VehicleStateStamped(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_vehicle_state_msgs__msg__VehicleStateStamped(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vehicle_state_msgs, msg, VehicleStateStamped)() {
