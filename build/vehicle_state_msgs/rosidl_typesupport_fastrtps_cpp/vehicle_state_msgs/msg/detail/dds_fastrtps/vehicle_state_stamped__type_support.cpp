...
#include "vehicle_state_msgs/msg/detail/vehicle_state_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vehicle_state_msgs::msg::VehicleStateStamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vehicle_state_msgs::msg::VehicleStateStamped & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_vehicle_state_msgs
max_serialized_size_VehicleStateStamped(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const vehicle_state_msgs::msg::VehicleStateStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vehicle_state_msgs::msg::VehicleStateStamped *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VehicleStateStamped__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const vehicle_state_msgs::msg::VehicleStateStamped *>(
...
{
  return max_serialized_size_VehicleStateStamped(full_bounded, 0);
}

static message_type_support_callbacks_t _VehicleStateStamped__callbacks = {
...
static rosidl_message_type_support_t _VehicleStateStamped__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VehicleStateStamped__callbacks,
...
{
  return &vehicle_state_msgs::msg::typesupport_fastrtps_cpp::_VehicleStateStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vehicle_state_msgs, msg, VehicleStateStamped)() {
  return &vehicle_state_msgs::msg::typesupport_fastrtps_cpp::_VehicleStateStamped__handle;
}
