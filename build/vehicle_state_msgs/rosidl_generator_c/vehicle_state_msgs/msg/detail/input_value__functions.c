...
vehicle_state_msgs__msg__InputValue__init(vehicle_state_msgs__msg__InputValue * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    vehicle_state_msgs__msg__InputValue__fini(msg);
    return false;
  }
  // position_x
  // position_y
...
vehicle_state_msgs__msg__InputValue__create()
{
  ...
  vehicle_state_msgs__msg__InputValue * msg = (vehicle_state_msgs__msg__InputValue *)allocator.allocate(sizeof(vehicle_state_msgs__msg__InputValue), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(vehicle_state_msgs__msg__InputValue));
  bool success = vehicle_state_msgs__msg__InputValue__init(msg);
  if (!success) {
...
vehicle_state_msgs__msg__InputValue__Sequence__init(vehicle_state_msgs__msg__InputValue__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vehicle_state_msgs__msg__InputValue * data = NULL;

  if (size) {
    data = (vehicle_state_msgs__msg__InputValue *)allocator.zero_allocate(size, sizeof(vehicle_state_msgs__msg__InputValue), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = vehicle_state_msgs__msg__InputValue__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        vehicle_state_msgs__msg__InputValue__fini(&data[i - 1]);
      }
...
vehicle_state_msgs__msg__InputValue__Sequence__fini(vehicle_state_msgs__msg__InputValue__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      vehicle_state_msgs__msg__InputValue__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vehicle_state_msgs__msg__InputValue__Sequence * array = (vehicle_state_msgs__msg__InputValue__Sequence *)allocator.allocate(sizeof(vehicle_state_msgs__msg__InputValue__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = vehicle_state_msgs__msg__InputValue__Sequence__init(array, size);
  if (!success) {
...
vehicle_state_msgs__msg__InputValue__Sequence__destroy(vehicle_state_msgs__msg__InputValue__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    vehicle_state_msgs__msg__InputValue__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
vehicle_state_msgs__msg__InputValue__Sequence__are_equal(const vehicle_state_msgs__msg__InputValue__Sequence * lhs, const vehicle_state_msgs__msg__InputValue__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!vehicle_state_msgs__msg__InputValue__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  vehicle_state_msgs__msg__InputValue__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(vehicle_state_msgs__msg__InputValue);
    vehicle_state_msgs__msg__InputValue * data =
      (vehicle_state_msgs__msg__InputValue *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vehicle_state_msgs__msg__InputValue__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          vehicle_state_msgs__msg__InputValue__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!vehicle_state_msgs__msg__InputValue__copy(
