...
static const _InputValue_type_support_symbol_names_t _InputValue_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vehicle_state_msgs, msg, InputValue)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vehicle_state_msgs, msg, InputValue)),
  }
};
...
{
  return &::vehicle_state_msgs::msg::rosidl_typesupport_cpp::InputValue_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vehicle_state_msgs, msg, InputValue)() {
  return get_message_type_support_handle<vehicle_state_msgs::msg::InputValue>();
}
