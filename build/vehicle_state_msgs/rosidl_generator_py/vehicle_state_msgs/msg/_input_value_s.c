...
bool vehicle_state_msgs__msg__input_value__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_state_msgs.msg._input_value.InputValue", full_classname_dest, 46) == 0);
  }
  vehicle_state_msgs__msg__InputValue * ros_message = _ros_message;
  {  // header
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * vehicle_state_msgs__msg__input_value__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of InputValue */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_state_msgs.msg._input_value");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "InputValue");
  ...
  vehicle_state_msgs__msg__InputValue * ros_message = (vehicle_state_msgs__msg__InputValue *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
