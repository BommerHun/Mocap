...
bool vehicle_state_msgs__msg__vehicle_state_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_state_msgs.msg._vehicle_state_stamped.VehicleStateStamped", full_classname_dest, 65) == 0);
  }
  vehicle_state_msgs__msg__VehicleStateStamped * ros_message = _ros_message;
  {  // header
  ...
  {  // erpm
    ...
    assert(PyFloat_Check(field));
    ros_message->erpm = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of VehicleStateStamped */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_state_msgs.msg._vehicle_state_stamped");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VehicleStateStamped");
  ...
  {  // erpm
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->erpm);
    {
