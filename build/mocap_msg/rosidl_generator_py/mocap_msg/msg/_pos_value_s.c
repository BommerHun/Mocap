...
bool mocap_msg__msg__pos_value__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mocap_msg.msg._pos_value.PosValue", full_classname_dest, 33) == 0);
  }
  mocap_msg__msg__PosValue * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of PosValue */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mocap_msg.msg._pos_value");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PosValue");
