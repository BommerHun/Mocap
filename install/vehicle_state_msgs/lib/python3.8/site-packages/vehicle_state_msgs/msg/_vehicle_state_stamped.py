...
class Metaclass_VehicleStateStamped(type):
    """Metaclass of message 'VehicleStateStamped'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'vehicle_state_msgs.msg.VehicleStateStamped')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__vehicle_state_stamped
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__vehicle_state_stamped
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__vehicle_state_stamped
            cls._TYPE_SUPPORT = module.type_support_msg__msg__vehicle_state_stamped
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__vehicle_state_stamped
...
class VehicleStateStamped(metaclass=Metaclass_VehicleStateStamped):
    """Message class 'VehicleStateStamped'."""
